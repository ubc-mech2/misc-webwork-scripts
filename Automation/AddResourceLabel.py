#Description:
#Updates the '## RESOURCES()' tag in every .pg file in a directory.
#Every referenced image name in the .pg file will be added into this tag.
#Actually works with multiple image references.
...
#How to use:
#Drop this .py file in a directory where .pg files need their image '## RESOURCES()' tag needs to be updated.
#Run this script.
